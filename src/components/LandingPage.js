...
const LandingPage = () => {
  return (
    ...
    <div className='DLandingPage mw7 ma6 pa5 ph10 ba br3 fl w-100 gold bg-lightest-blue'>
      ...
      <center><Link to='/register'>Register</Link> or <Link to='/login'>Login</Link></center>
    </div>
